@echo off
REM Run 2: Resume from checkpoint200, scaling_w=0.3, re-watermark augmentation (rewm_prob=0.3)
REM Goal: train extractor to resist Meta-model overwrite attacks
python train.py ^
  --image_dataset none ^
  ...
  --resume_from output/run1_video/checkpoint200.pth ^
